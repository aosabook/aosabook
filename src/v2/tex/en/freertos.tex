...
% fixme: shouldn't have heading directly below heading // Stetting --ARB
...
Each list element holds a number, \code{xItemValue}, that is
...
\code{xListEnd} element.  \code{xListEnd.xItemValue} is a sentinel
...
\pagebreak % to keep this para and code together --ARB Mar 30 12
