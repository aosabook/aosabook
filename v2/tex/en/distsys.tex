...
\aosafigure[250pt]{../images/distsys/simpleWeb.png}{Simple web applications}{fig.distsys.5}
...
\aosafigure[200pt]{../images/distsys/overSimpleWeb.png}{Oversimplified web application}{fig.distsys.6}
...
\aosafigure[300pt]{../images/distsys/cache.png}{Inserting a cache on your request layer node}{fig.distsys.8}
...
\aosafigure[230pt]{../images/distsys/multipleCaches.png}{Multiple caches}{fig.distsys.9}
...
\aosafigure[300pt]{../images/distsys/globalCache1.png}{Global cache where cache is responsible for retrieval}{fig.distsys.10}

\aosafigure[240pt]{../images/distsys/globalCache2.png}{Global cache where request nodes are responsible for retrieval}{fig.distsys.11}
...
\aosafigure[250pt]{../images/distsys/distributedCaching.png}{Distributed cache}{fig.distsys.12}
...
performance, \url{http://sizzo.org/talks/}.}. They use \code{\$GLOBALS} and
...
\aosafigure[250pt]{../images/distsys/proxies.png}{Proxy server}{fig.distsys.13}
...
\aosafigure{../images/distsys/collapseRequestsSpatial.png}{Using a proxy to collapse requests for data that is spatially close together}{fig.distsys.15}
...
\aosafigure[300pt]{../images/distsys/loadBalancer.png}{Load balancer}{fig.distsys.18}
...
\aosafigure[325pt]{../images/distsys/synchronousRequest.png}{Synchronous request}{fig.distsys.20}
